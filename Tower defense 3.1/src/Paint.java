    ...
    public void paintMissiles(){
        ...
        for (int i = 0; i < GameField.missiles.length; i++) {
            if (GameField.missiles[i] != null) {
                g2d.rotate(GameField.missiles[i].direction + Math.toRadians(90), (int) GameField.missiles[i].x, (int) GameField.missiles[i].y);
                g.drawImage(GameField.missiles[i].texture, (int) GameField.missiles[i].x, (int) GameField.missiles[i].y, 20, 20, null);
                g2d.rotate(-GameField.missiles[i].direction + Math.toRadians(-90), (int) GameField.missiles[i].x, (int) GameField.missiles[i].y);
            }
        }
    }
    ...
    public void paintNormalBullet() {
        ...
        for (int i = 0; i < GameField.normalBullet.length; i++) {
            if (GameField.normalBullet[i] != null) {
                g2d.rotate(GameField.normalBullet[i].direction + Math.toRadians(90), (int) GameField.normalBullet[i].x, (int) GameField.normalBullet[i].y);
                g.drawImage(GameField.normalBullet[i].texture, (int) GameField.normalBullet[i].x, (int) GameField.normalBullet[i].y, 30, 20, null);
                g2d.rotate(-GameField.normalBullet[i].direction + Math.toRadians(-90), (int) GameField.normalBullet[i].x, (int) GameField.normalBullet[i].y);
            }
        }
    }
