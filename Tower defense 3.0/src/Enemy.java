...
public class Enemy {
    ...
    public static Enemy normalEnemy = new NormalEnemy(0, 30, 70, 16, 1.7, 10, 1).getTextureFile("gun2");
    public static Enemy normalEnemy1 = new NormalEnemy(1, 50, 100, 13, 1.7, 10, 2).getTextureFile("enemy");
    public static Enemy Boss = new NormalEnemy(2, 80, 150, 16, 1.7, 10, 2).getTextureFile("enemy2");
